    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
            ...
            <main role="main" aria-label="Dashboard content">
                ...
                <section className={`bg-gradient-to-r ${currentTheme.gradient} rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 shadow-lg`} aria-labelledby="welcome-heading">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div className="flex-1">
                            <h1 id="welcome-heading" className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-1 sm:mb-2 flex items-center gap-2">
                                Welcome to {user?.institution_name || 'Your Institution'}! <span role="img" aria-label="waving hand">👋</span>
                            </h1>
                        ...
                        <div className="text-left sm:text-right">
                            ...
                            <p className="text-white font-semibold text-base sm:text-lg" aria-live="polite">{getCurrentDate()}</p>
                        </div>
                    </div>
                </section>

                {/* Stats Cards - Mobile Responsive */}
                <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6" aria-label="Attendance statistics">
                    <StatCard
